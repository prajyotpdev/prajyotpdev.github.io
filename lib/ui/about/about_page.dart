...
//     Experience('Apr 2018', 'Present', 'Embrace-it India', 'Sr. Software Engineer'),
//     Experience('July 2014', 'March 2016', 'Citrusbits', 'Software Engineer'),
//   ];
// }
//
...
//                 duration: const Duration(milliseconds: 400),
//                 height: isOut ? 0.0 : 100.0,
//                 width: isOut ? 0.0 : 100.0,
//                 decoration: BoxDecoration(color: Colors.greenAccent, backgroundBlendMode:BlendMode.darken ,borderRadius: BorderRadius.circular(50.0)),
//               ),
//             ),
//           ],
//         ),
...
//             child: Row(
//               mainAxisSize: MainAxisSize.max,
//               children: <Widget>[Expanded(flex: 1, child: _buildContent(context))],
//             ),
//           ),
//           _buildFooter(context),
//         ],
...
//       children: <Widget>[
//         SizedBox(height: ResponsiveWidget.isSmallScreen(context) ? 24.0 : 100.0),
...
//     final List<Widget> widgets = AboutPage.experienceList.map((experience) => _buildExperienceTile(experience)).toList();
